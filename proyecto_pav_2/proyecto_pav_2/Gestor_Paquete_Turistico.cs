...
namespace proyecto_pav_2
{
    ...
    {
        private static Acceso_A_Datos ad;
        private static List<Paquete_Turistico> lpt;
        private static string sql;

        public static DataTable buscar_paquetes()
        {
            ad = new Acceso_A_Datos();
        ...
        public static Paquete_Turistico buscar_por_id(int id_paquete_turistico)
        {
        ...
        public static void agregar_paquete(Paquete_Turistico p) 
        {
            ad = new Acceso_A_Datos();
            int id_paquete=0;
        ...
        public static void modificar_paquete(Paquete_Turistico p) 
        {
            ad = new Acceso_A_Datos();
        ...
        public static void eliminar_paquete(Paquete_Turistico p) 
        {
            ad = new Acceso_A_Datos();
